        ...
        '<tr>' +
          ...
          '<td valign="middle">' +
            '<a href="https://namba.ngo" style="text-decoration:none; border:0;">' +
              '<img src="' + SITE + '/assets/images/logos/email-logo.png" alt="NAMBA, Niseko Area Mountain Bike Association" width="150" height="94" style="display:block; width:150px; height:94px; border:0;">' +
            '</a>' +
          '</td>' +
        '</tr>' +
      '</table>' +
