...
parts:
  - name: トレイル整備の朝
    ...
    what: NAMBAクルーと<wbr>トレイル整備、<wbr>BBQランチ、<wbr>限定Tシャツ、<wbr>スポンサーグッズ
  - name: 3周年パーティー
    free: true
    when: 13時から<wbr>夜まで
    cost: 無料
    booking: 予約不要、<wbr>直接<wbr>お越しください
    what: ミニゲーム、<wbr>ゲームチケット5枚、<wbr>17時から<wbr>抽選会、<wbr>Rhythmで<wbr>パーティー
partners:
  - name: Specialized
    img: /specialized.png
...
faq:
  ...
  - q: トレイル整備に参加した人は、ゲームチケットを多くもらえますか？
    a: いいえ。3周年パーティーにお越しの方は全員、同じ5枚からのスタートです。追加のチケットも、ゲームに挑戦するという同じ方法で全員が獲得します。トレイル整備の朝のチケットに含まれるのは、午前の整備、ランチ、Tシャツ、スポンサーグッズです。
  - q: ゲームチケットを購入できますか？
    a: いいえ。ゲームチケットは販売しておらず、これまでも販売したことはありません。入手方法は、3周年パーティーにお越しいただくことだけです。
  - q: 17時の抽選会にいないと当選できませんか？
    a: いいえ。お名前をお預けいただければ、賞品をお届けします。
  - q: ツインピークスは無料で利用できますか？
    a: はい。ツインピークス・バイクパークは無料で、どなたでもご利用いただけます。
---
...
- NAMBAクルーと​一緒に​取り組む、​午前の​トレイル整備。
- BBQランチ、​Pow Bar、​ソフトドリンク、​そして​大人の​方には​ヨーテイブルーイングの​[ツインピークスバイクパーク ペールエール](/ja/beer/)。
- この​イベントの​ためだけに​作る​限定Tシャツ。​イベント後の​販売は​ありません。
- 受付で​お渡しする、​スポンサーからの​グッズ。
- NAMBAと​ツインピークスの​ステッカー。
...
パンプトラックの​タイムトライアル、​デュアルスラローム、​ログライド、​バニーホップ、​トラックスタンド、​それに​ディグデイで​おなじみの​種目も。​パーク内の​あちこちで、​15時30分まで。​参加は​無料で、​何回でも​挑戦できます。
...
抽選会は​17時。​その​あと​Rhythmへ​場所を​移します。​今年は​例年より​人が​多いぶん、​当たる​確率は​下がりますが、​そのぶん​賑やかに​なります。
