    ...
    - hasLocations: false
      events:
        ...
        - time: 12:30pm
          name: BBQランチ
        - time: 1:00pm
          name: 3周年パーティー開始、<wbr>受付で<wbr>ゲームチケットを<wbr>配布
          free: true
        - time: 1:00pm
          name: ミニゲーム開始
          free: true
...
faq:
  - q: ゲームや抽選会に参加するには、トレイル整備の朝のチケットが必要ですか？
    a: いいえ。ゲーム、抽選会、パーティーはすべて無料で、どなたでもご参加いただけます。13時以降のお好きな時間にお越しいただき、受付でゲームチケット5枚をお受け取りください。
...
午後は​こちらからの​お祝いです。​ツインピークスは​誰でも​無料で​走れる​バイクパークですし、​3周年も​それと​同じ。​午前に​一緒に​掘った​方も、​お昼に​走りに​来た方も、​パーティーだけ顔を​出す方も、​みなさん​歓迎です。
...
3周年パーティーに​お越しの​方は​全員、​ゲームチケットを​5枚お受け取りいただけます。​13時以降、​受付で​どうぞ。​午前の​整備に​参加された​方も、​お昼から​来られた​方も、​同じ​条件です。​ゲームに​挑戦すれば、​さらに​増やせます。​ゲームチケットは​販売しておらず、​これまでも​販売した​ことは​ありません。​会場に​お越しいただく​ことが、​唯一の​入手方法です。
